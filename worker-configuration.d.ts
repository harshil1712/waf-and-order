/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 027d79ffddd8f3555955a019b741197f)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BOT_TRAFFIC_ANALYTICS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	AI: Ai;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEAM_DOMAIN" | "POLICY_AUD" | "OPERATOR_ALLOWED_ORIGINS">> {}
}
